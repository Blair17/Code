...
-- S:SetLayerPatternCircle('Grating', 'Air', {0,0}, 375)
-- S:AddLayer('Grating1', ITO_under, 'GratingMaterial') 
...
for lambda = lambdain, lambdafin, deltalambda do
  ...
  refl = - back/inc
  Exr, Eyr, Ezr, Exi, Eyi, Ezi = S:GetEField({0,0,gratingthickness}) 
